        ...
        <>
          ...
          >
            <div
              ...
              aria-modal="true"
              tabIndex={-1}
              className={`relative flex max-h-[90vh] w-full flex-col ${maxWidthClassName} overflow-hidden rounded-2xl border border-border bg-card shadow-2xl outline-none`}
            >
              ...
              {footer && <div className="shrink-0 border-t border-border px-6 py-4 flex justify-end gap-2">{footer}</div>}
            </div>
          </motion.div>
        </>
      )}

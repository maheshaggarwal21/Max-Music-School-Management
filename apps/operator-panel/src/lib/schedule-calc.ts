// Derive "No. of Days" and "No. of Classes" for an enrollment window — given a
// validity start/end and the batch's (active) day pattern. Mirrors the
// institution admin panel's calc so the operator edit form behaves identically.
